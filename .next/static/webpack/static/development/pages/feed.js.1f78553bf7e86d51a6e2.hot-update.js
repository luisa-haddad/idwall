...
var GetFeedData = function GetFeedData(props, href) {
  ...
  console.log(router.asPath.indexOf('husky'), 'teste');
  var category = router.query.category ? router.query.category : 'husky';
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    className: router.asPath.indexOf('husky') > 0 ? 'active' : null,
    ...
    className: router.asPath.indexOf('labrador') > 0 ? 'active' : null,
    onClick: function onClick() {
    ...
    className: router.asPath.indexOf('hound') > 0 ? 'active' : null,
    onClick: function onClick() {
    ...
    className: router.asPath.indexOf('pug') > 0 ? 'active' : null,
    onClick: function onClick() {
...
//# sourceMappingURL=feed.js.1f78553bf7e86d51a6e2.hot-update.js.map